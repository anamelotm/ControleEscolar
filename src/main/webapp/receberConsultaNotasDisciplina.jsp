...
<html>
    ...
    <body>
        <%
            ...
            List<Notas> listaNotas = nDAO.consultarNotaPorDisciplina(codDisciplina);
        %>
        <table id="consulta" >
            <!-- cabecalho da tabela -->
            <thead>
            ...
            <tfoot style="text-align: end;">
            	...
            	<td colspan="2" ><strong><%out.write(String.valueOf(nDAO.calcularMediaDisciplina(codDisciplina))); %></strong></td>
            </tfoot>
        </table>
    </body>
</html>